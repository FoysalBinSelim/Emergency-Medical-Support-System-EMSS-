...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="hospital_icu" id="exampleInputPassword1" placeholder="Lattitude">
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1">Longitude</label>
    <input type="text" class="form-control" name="hospital_icu" id="exampleInputPassword1" placeholder="Longitude">
  </div>
